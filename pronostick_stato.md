...
| **Ultima sessione** | Pronostick.Code: Sessione 3 (guida/FAQ `istruzioni.html`) completata — roadmap Pronostick.Code (Sessioni 1-3) ora chiusa, resta solo la verifica del test Musetti-Arnaldi (partita 27/07/2026) |
...
- [ ] **Verifica del primo test end-to-end** — analisi già fatta (`2026-07-27_musetti-vs-arnaldi.json`, pronostico "1 Musetti" @1.36, confidenza 58/100, nessun value bet), partita in programma lunedì 27/07/2026: appena giocata, verificare con la skill e validare l'intero processo (analisi → salvataggio → dashboard → verifica) in un colpo solo, segnalando qualunque cosa non sia andata come previsto
...
- [x] Sessione 3 — Guida/FAQ (`Pronostick.Code/istruzioni.html`) — guida completa (scelta esplicita di Fabio tra "essenziale"/"completa"), stesso stile di `dashboard.html`, 5 sezioni (Cos'è, Come si usa, Dati & Memoria, Dashboard, FAQ ad accordion). Tab switching e toggle FAQ verificati via browser. Roadmap Pronostick.Code (Sessioni 1-3) ora completa
