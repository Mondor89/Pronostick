...
| **Ultima sessione** | Controllati i model ID Anthropic nel dropdown Menu ⚙️: trovati 2 modelli su 4 già oltre la data di ritiro Anthropic (rischio 404 silenzioso) — sostituiti con `claude-sonnet-5` e `claude-opus-4-8` |
...
## Focus Attuale
App funzionante e deployata. Nessun bug noto aperto al momento. Verificati i model ID Anthropic esposti nel dropdown Menu ⚙️ — 2 su 4 erano già oltre la data di ritiro, corretti in sessione. Prossimo passo: sistema Tag Pattern per AI Memory.
...
- [ ] Valutare upgrade tool `web_search_20250305` → `web_search_20260209` (dynamic filtering, più efficiente) — richiede logica condizionale per modello, non supportato da Haiku 4.5/Sonnet 4.5 (vedi Log Sessioni 14/07/2026)
